...
\cventry{March~2022 -- Now}{Machine learning engineer}{Rainbow.ai}{Warsaw}{}{
\begin{itemize}
    \item Weather prediction using deep learning models (Python, PyTorch, Image processing, Weather data)
\end{itemize}}

\cventry{November~2021 -- February~2022}{Machine learning engineer}{Descriptor.ai}{Remote/Moscow}{}{
\begin{itemize}
    \item I created a few good-performing voice sentiment analysis models (Python, NumPy, TensorFlow, Keras, Voice data).
\end{itemize}}
