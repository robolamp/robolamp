...
\item Self-driving car perception software:
  ...
  \item Traffic lights recognition pipeline (ROS, C++, Python, NumPy, TensorFlow, Keras).
    Traffic lights recognition and tracking pipeline; learning data mining and pre-processing;
    creating, training and deployment of deep learning models.
  \end{itemize}
\item Talks about Yandex Self-Driving Cars project:
  \begin{itemize}
