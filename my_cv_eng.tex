...
\cventry{November~2022 -- Now}{Machine learning engineer}{Stability.ai}{Warsaw/Amsterdam}{}{
  I worked on the following projects:
\begin{itemize}   
    \item Stable-Finetuning (Python, PyTorch, CUDA, diffusion models):
    My responsibility was pre-processing and algorithm side of the service and only a bit on ifrastructure.
    \item LLM-related effort.
    \item Brain2image effort.
\end{itemize}}
...
\cventry{2020}{Method of and system for determining traffic signal state}{}{}{}{
  ...
  \begin{itemize}
    \item US Patent US20210201058A1, application at 2020.09.28, pending.
